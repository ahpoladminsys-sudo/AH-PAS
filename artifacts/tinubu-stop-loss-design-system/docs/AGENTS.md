# Tinubu Stop Loss Design System design system
...
workspace package (`@workspace/tinubu-stop-loss-design-system`): other artifacts depend
...
- `docs/references/` — the extracted source catalog and per-family contracts for
  the Stop Loss workspace. Read `component-inventory.md` before adding or
  promoting a shared family.
...
`@workspace/tinubu-stop-loss-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/tinubu-stop-loss-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/tinubu-stop-loss-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/tinubu-stop-loss-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/tinubu-stop-loss-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/tinubu-stop-loss-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/tinubu-stop-loss-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/tinubu-stop-loss-design-system/docs/migrating-expo.md`
