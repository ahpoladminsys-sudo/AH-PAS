# Consuming Tinubu Stop Loss Design System in Expo apps

Read `artifacts/tinubu-stop-loss-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/tinubu-stop-loss-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/tinubu-stop-loss-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/tinubu-stop-loss-design-system/lib/native-theme";
import { useColors } from "@workspace/tinubu-stop-loss-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/tinubu-stop-loss-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/tinubu-stop-loss-design-system/components/native/badge";
import { Button } from "@workspace/tinubu-stop-loss-design-system/components/native/button";
import { Card } from "@workspace/tinubu-stop-loss-design-system/components/native/card";
```
...
Import and render
`@workspace/tinubu-stop-loss-design-system/components/native/button`, then run Expo
