# Consuming Tinubu Stop Loss Design System in web apps

Read `artifacts/tinubu-stop-loss-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/tinubu-stop-loss-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/tinubu-stop-loss-design-system/styles.css";
```
...
`node_modules/@workspace/tinubu-stop-loss-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/tinubu-stop-loss-design-system/components/ui/button";
import { cn } from "@workspace/tinubu-stop-loss-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/tinubu-stop-loss-design-system/hooks/use-toast";
```
...
`@workspace/tinubu-stop-loss-design-system/components/ui/button`. Run the app's typecheck
