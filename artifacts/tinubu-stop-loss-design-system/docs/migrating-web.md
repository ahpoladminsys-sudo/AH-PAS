# Migrating web UI to Tinubu Stop Loss Design System

Read `artifacts/tinubu-stop-loss-design-system/docs/AGENTS.md` and
`artifacts/tinubu-stop-loss-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/tinubu-stop-loss-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/tinubu-stop-loss-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/tinubu-stop-loss-design-system/hooks/use-toast`
